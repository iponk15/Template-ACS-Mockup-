 ...
 */
$config['site_title']                 = "Hotel Aircrew System";       // Site Title, example.com
$config['admin_email']                = "admin@has.com"; // Admin Email, admin@example.com
...
$config['identity']                   = '';             // You can use any unique column in your table as identity column. The values in this column, alongside password, will be used for login purposes
