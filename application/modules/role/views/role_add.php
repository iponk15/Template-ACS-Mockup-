<div class="m-portlet m-portlet--mobile">
	...
	<form class="m-form m-form--fit m-form--label-align-right form_add" action="<?php echo base_url($url.'/action_add') ?>" method="post" onsubmit="return submitMe()">
				...
				<div class="col-md-4">
					<div class="form-group m-form__group row">
						...
						<div class="col-lg-8 col-md-9 col-sm-12">
							<input class="form-control m-input" type="text" name="role_nama" placeholder="Masukkan nama" tabindex="2" autocomplete="off">
						</div>
					</div>
					<div class="form-group m-form__group row">
						<label for="example-text-input" class="col-form-label col-lg-4 col-sm-12">Deskripsi</label>
						<div class="col-lg-8 col-md-9 col-sm-12">
							<textarea class="form-control m-input" name="role_deskripsi" placeholder="Masukkan deskripsi" cols="30" rows="5" tabindex="3"></textarea>
						</div>
					</div>
				</div>
				<div class="col-md-4">
	...
	$(document).ready(function () {
		...
		$("#m_tree_3").jstree({
            ...
            core: {
                ...
                data : {
	              'url' : base_url+'role/preview_menu?operation=get_node',
	              'data' : function (node) {
	                return { 'id' : node.id };
	              },
	              "dataType" : "json"
